...
AUTH_LDAP_SERVER = ""
AUTH_LDAP_SEARCH = ""
# AUTH_LDAP_APPEND_DOMAIN = "cloudminds.com"
# AUTH_LDAP_USERNAME_FORMAT = "cn=%s,ou=services,dc=cloudminds,dc=com"
...
class CeleryConfig:  # pylint: disable=too-few-public-methods
    BROKER_URL = 'redis://10.12.32.24:6379/0'
    CELERY_IMPORTS = ("superset.sql_lab", "superset.tasks")
    CELERY_RESULT_BACKEND = 'redis://10.12.32.24:6379/0'
...
SMTP_HOST = "mail.cloudminds.com.cn"
SMTP_STARTTLS = False
SMTP_SSL = False
SMTP_USER = "superset@cloudminds.com.cn"
SMTP_PORT = 25
SMTP_PASSWORD = "Cloudsuperset1688"
SMTP_MAIL_FROM = "superset@cloudminds.com.cn"
...
WEBDRIVER_WINDOW = {"dashboard": (1920, 2000), "slice": (3000, 1200)}

# Any config options to be passed as-is to the webdriver
WEBDRIVER_CONFIGURATION: Dict[Any, Any] = {}

# The base URL to query for accessing the user interface
#WEBDRIVER_BASEURL = "http://10.12.32.24:8088/"
